...
@section('content')
    <div class="row flex-wrap">
        <form class="col-12 d-flex flex-wrap justify-content-between" id="orderForm" action="{{ route('user.store') }}"
                ...
                <div class="card-body">
                    <div class="row flex-wrap">
                        <div class="col-8 d-flex flex-wrap">
                            ...
                            <div class="col-12 d-flex flex-wrap p-0">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input value="{{ old('card_id') ? e(old('card_id')) : '' }}" type="text"
                                        id="card_id" name="card_id" class="form-control" />
                                    @error('card_id')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group col-6 ">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="birth_date" class="form-control datepicker"
                                            name="birth_date" />
                                        @error('birth_date')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                        ...
                        <div class="col-4 d-flex flex-wrap align-self-baseline">
                            <h5 class="col-12 pt-2">PDF uploading</h5>
                            <div class="col-12">
                                <hr class="mt-0">
                            </div>
                            <div class="form-group col-12">
                                ...
                                <div id="pdfPreviewContainer"
                                    ...
                                    <object id="pdfPreview" type="application/pdf"
