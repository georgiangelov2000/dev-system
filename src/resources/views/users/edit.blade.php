                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select name="gender" id="gender" class="form-control">
                                        @foreach (config('statuses.genders') as $key => $value)
                                            <option {{$key == $user->gender ? 'selected' : ''}} value="{{ $key }}">{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('gender')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select name="role_id" id="role_id" class="form-control">
                                        @foreach (config('statuses.roles') as $key => $role)
                                            <option {{$key == $user->role_id ? 'selected' : ''}} value="{{ $key }}">{{ $role }}</option>
                                        @endforeach
                                    </select>
                                    @error('role_id')
                                        <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="form-group col-12">
                        ...
                        @else
                            <div id="pdfPreviewContainer" style="margin-top: 20px;">
                                <object data="{{ $user->pdf_file_path }}" id="pdfPreview" type="application/pdf" style="width: 100%; height: 600px;"></object>
                            </div>
                        @endif
                    </div>
