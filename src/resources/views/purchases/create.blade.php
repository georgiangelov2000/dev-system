            ...
            <form class="d-flex flex-wrap" action='{{ route('purchases.store') }}' method='POST' enctype="multipart/form-data">
                ...
                <div class="row flex-wrap">
                    <div class="col-10 d-flex flex-wrap">
                        ...
                        <div class="col-12 d-flex flex-wrap p-0">
                            <h5 class="col-12 pt-2">Calculation fields</h5>
                            <div class="col-12">
                                <hr class="mt-0">
                            </div>
                            <div class="form-group col-3">
                            ...
                            <div class="form-group col-2">
                                ...
                                <input type="number" class="form-control @error('weight')  is-invalid @enderror"
                                    id="weight" name="weight" min="0" value="0"
                                    placeholder="Enter a integer value (e.g.,1,2)"
                                    value='{{ old('weight') ? e(old('weight')) : '' }}'>
                                @error('weight')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group col-2">
                                ...
                                <input type="number" class="form-control @error('height')  is-invalid @enderror"
                                    id="height" name="height" min="0" value="0"
                                    placeholder="Enter a integer value (e.g.,1,2)"
                                    value='{{ old('height') ? e(old('height')) : '' }}'>
                                @error('height')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 d-flex flex-wrap p-0">
                            <h5 class="col-12 pt-2">Expected dates</h5>
                            <div class="col-12">
                                <hr class="mt-0">
                            </div>
                            <div class="form-group col-3">
