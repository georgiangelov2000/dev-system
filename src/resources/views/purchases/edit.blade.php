                        ...
                        <form class="d-flex flex-wrap" action='{{ route('purchase.update', $product->id) }}' method='POST'
                            ...
                            <div class="row w-100">
                                @if ($product->images && count($product->images) > 1)
                                    <div id="carouselExampleControls" class="col-3 carousel slide" data-ride="carousel">
                            ...
                            @else
                                <div class="form-group col-6 d-flex align-items-center mx-0 mb-0">
                                    <h6 class="text-danger mb-0">
                                        You reached maximum capacity of images for current purchase (3), you can delete
                                        the images from
                                        product gallery
                                    </h6>
                                </div>
                            ...
                            <div class="form-group col-6">
                                ...
                                <input type="text" class="form-control @error('name')  is-invalid @enderror"
                                    id="name" name="name" value='{{ e($product->name) }}' placeholder="Enter name">
                                @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('code')  is-invalid @enderror"
                                            id="code" name="code" value='{{ e($product->code) }}'
                            ...
                            <div class="col-12 d-flex p-2">
                                @foreach ($product->images as $image)
                                    <div class="col-3 productImage" style="position: relative;">
                                        <img style="height: 200px; object-fit: cover;" class="d-block card card-widget widget-user w-100" src="{{ $image->path . $image->name }}">
                                        <form id="deleteImageForm" data-image-id="{{ $image->id }}" action="{{ route('purchase.delete.image', $product->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button id="deletePurchaseImage" title="Delete" class="btn btn-dark" style="position: absolute; opacity: 0.8; top: 50%; left: 50%; transform: translate(-50%, -50%);">
