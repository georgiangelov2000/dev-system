...
<div class="card card-default cardTemplate">
    ...
    <div class="card-body">
        <form class="d-flex flex-wrap" action='{{route('product.update',$product->id)}}' method='POST' enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group col-6">
                ...
                <div class="form-group">
                    ...
                    <select 
                        class="form-control selectBrands" multiple data-selected-text-format="count > 12" 
