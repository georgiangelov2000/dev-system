                ...
                <div class="row flex-wrap">
                    <div class="col-10 d-flex flex-wrap p-2">
                        ...
                        <div class="form-group col-5">
                            ...
                            <textarea cols="3" rows="1" maxlength="255" class="form-control @error('notes')  is-invalid @enderror" name="notes">{{ e($supplier->notes) }}</textarea>
                            @error('notes')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group addresses col-5 d-none"></div>
