                ...
                <div class="row flex-wrap">
                    <div class="col-10 d-flex flex-wrap p-2">
                        ...
                        <div class="form-group col-3">
                            ...
                            <select data-live-search="true" class="form-control selectCountry"
                        ...
                        <div class="form-group col-3">
                            <label class="form-label required" for="country">Categories</label>
                            <select data-live-search="true" multiple="" class="form-control selectCategory" name="categories[]"
                                data-actions-box="true" data-dropup-auto="false " multiple data-selected-text-format="count > 1">
                            </select>
                            @error('categories')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group col-5">
                            ...
                            <textarea cols="3" rows="1" maxlength="255" class="form-control @error('notes')  is-invalid @enderror" class="form-control" name="notes"
                                value='{{ old('notes') ? e(old('notes')) : '' }}'></textarea>
                            @error('notes')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group col-5 addresses d-none"></div>
